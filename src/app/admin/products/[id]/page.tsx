...
export default async function Editor({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (<form action={saveProduct} className="editor"><div>
    ...
    <div style={{ display: "flex", gap: 10, marginTop: 8 }}><button className="btn">Save piece</button><Link className="btn ghost" href="/admin">Cancel</Link></div>
  </div><div>
