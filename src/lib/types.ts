export type Settings = {
  ...
  contact_email: string; instagram: string; shipping_note: string;
};
export type Product = {
...
export type Order = {
  id: string; status: OrderStatus; razorpay_order_id: string; razorpay_payment_id: string; total: number;
